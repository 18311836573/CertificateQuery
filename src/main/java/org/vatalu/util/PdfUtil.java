...
public class PdfUtil {
	...
	public void createPdfs(String filepath, String pdfpath, String fontpath, List<Work> list) {
	...
	synchronized public void createPdf(String filename, String pdfpath, String fontpath, Work work) {
		PdfWriter writer;
		PdfReader reader;
		try {
